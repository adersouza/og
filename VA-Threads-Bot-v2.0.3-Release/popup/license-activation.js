...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  async function updateContactInfo() {
    try {
      // Find the Telegram link in the footer (it's in a <span> tag)
      ...
      if (data.success && data.data) {
        ...
        // Update the support text with dynamic link
        supportText.innerHTML = `Need help? Contact support at <a href="${telegramUrl || 'https://t.me/threadsva'}" target="_blank">@${telegramUsername || 'threadsva'}</a>`;
      }
    } catch (error) {
